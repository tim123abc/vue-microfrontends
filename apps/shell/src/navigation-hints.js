...
export function installNavigationHints() {
  if (!HTMLScriptElement.supports?.("speculationrules")) {
    appendLink({ rel: "prefetch", href: "/analytics" });
  }

  if (import.meta.env.DEV) {
    appendLink({ rel: "modulepreload", href: "/analytics/src/main.js" });
    appendLink({ rel: "preload", href: "/analytics/src/styles.css", as: "style" });
  }
}
